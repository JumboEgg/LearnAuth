...
public class CATToken extends Contract {
    ...
    @Deprecated
    protected CATToken(String contractAddress, Web3j web3j, Credentials credentials,
    ...
    @Deprecated
    protected CATToken(String contractAddress, Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
    ...
    @Deprecated
    public static CATToken load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new CATToken(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static CATToken load(String contractAddress, Web3j web3j,
    ...
    public static CATToken load(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new CATToken(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static CATToken load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new CATToken(contractAddress, web3j, transactionManager, contractGasProvider);
    }
