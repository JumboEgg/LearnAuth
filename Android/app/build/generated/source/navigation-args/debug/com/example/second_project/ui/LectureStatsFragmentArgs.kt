...
public data class LectureStatsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): LectureStatsFragmentArgs {
      bundle.setClassLoader(LectureStatsFragmentArgs::class.java.classLoader)
      ...
      return LectureStatsFragmentArgs(__lectureName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): LectureStatsFragmentArgs {
      val __lectureName : String?
