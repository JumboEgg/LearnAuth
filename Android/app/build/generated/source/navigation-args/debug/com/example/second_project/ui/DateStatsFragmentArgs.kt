...
public data class DateStatsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): DateStatsFragmentArgs {
      bundle.setClassLoader(DateStatsFragmentArgs::class.java.classLoader)
      ...
      return DateStatsFragmentArgs(__lectureName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): DateStatsFragmentArgs {
      val __lectureName : String?
