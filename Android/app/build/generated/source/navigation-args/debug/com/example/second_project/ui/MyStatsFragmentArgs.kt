...
public data class MyStatsFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): MyStatsFragmentArgs {
      bundle.setClassLoader(MyStatsFragmentArgs::class.java.classLoader)
      ...
      return MyStatsFragmentArgs(__lectureName)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): MyStatsFragmentArgs {
      val __lectureName : String?
