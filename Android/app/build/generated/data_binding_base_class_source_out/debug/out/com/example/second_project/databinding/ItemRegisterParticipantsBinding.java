...
public final class ItemRegisterParticipantsBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputEditText editRegisterUser;
  ...
  private ItemRegisterParticipantsBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout delete, @NonNull TextInputEditText editRegisterUser,
      @NonNull TextInputLayout editTextNameParticipants,
      @NonNull TextInputLayout editTextRatioParticipants, @NonNull ConstraintLayout isLecturer) {
    this.rootView = rootView;
    this.delete = delete;
    this.editRegisterUser = editRegisterUser;
  ...
  public static ItemRegisterParticipantsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editRegisterUser;
      TextInputEditText editRegisterUser = ViewBindings.findChildViewById(rootView, id);
      if (editRegisterUser == null) {
        break missingId;
      }
      ...
      return new ItemRegisterParticipantsBinding((ConstraintLayout) rootView, delete,
          editRegisterUser, editTextNameParticipants, editTextRatioParticipants, isLecturer);
    }
